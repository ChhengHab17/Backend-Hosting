...
export const generateQr = async (req, res) => {
  try {
    ...
    const pythonResponse = await axios.post(
      "https://networking-collecting-presently-academy.trycloudflare.com/generate-qr",
      payload
    );
...
export const verifyQr = async (req, res) => {
  try {
    ...
    const response = await axios.post(
      "https://networking-collecting-presently-academy.trycloudflare.com/check-payment",
      { md5 },
